/**
 * URL: ~/order/:id
 * Screen: OrderScreen. OrderScreen is used to display the order details after the user has placed an order.
 */
...
const OrderScreen = ({ match, history }) => {
  ...
  useEffect(() => {
    ...
    //TODO replace with paypal component
                    ...
                    <ListGroup.Item>
                      ...
                      {!sdkReady ? (
                        ...
                        <PayPalButton
                          ...
                          options={{ clientId: 'sb', currency: 'CAD' }}
                        />
                      )}
                    </ListGroup.Item>
                  )}
